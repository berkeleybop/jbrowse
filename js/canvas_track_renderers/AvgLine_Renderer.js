...
function AvgLine_Renderer()  {  }

AvgLine_Renderer.NAME = "AvgLine";
AvgLine_Renderer.ID = "AvgLine";

CanvasTrack.registerRenderer(AvgLine_Renderer);

AvgLine_Renderer.drawBlock = function (track, blockIndex, blockDiv,
					     leftBlock, rightBlock,
					     leftBase, rightBase,
					     scale, stripeWidth,
					     containerStart, containerEnd) {
    if (CanvasTrack.VERBOSE_RENDER) {  console.log("called AvgLine_Renderer.drawBlock");  }
