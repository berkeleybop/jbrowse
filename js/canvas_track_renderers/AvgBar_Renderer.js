...
function AvgBar_Renderer()  {  }

AvgBar_Renderer.NAME = "AvgBar";
AvgBar_Renderer.ID = "AvgBar";

CanvasTrack.registerRenderer(AvgBar_Renderer);

AvgBar_Renderer.drawBlock = function (track, blockIndex, blockDiv,
					     leftBlock, rightBlock,
					     leftBase, rightBase,
					     scale, stripeWidth,
					     containerStart, containerEnd) {
    if (CanvasTrack.VERBOSE_RENDER) {  console.log("called AvgBar_Renderer.drawBlock");  }
