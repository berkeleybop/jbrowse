describe("GFF3toJson", function() { 
	...
	it("should return a parent with the right ID in parsed JSON", function() {
		expect(jsonOutput["parsedData"][0]).toBeDefined();
	...
	it("should return a parent with correct data array of 9 element in parsed JSON", function() {
		...
		expect(jsonOutput["parsedData"][0]["data"] === ["Group1.33","maker","gene","245454","247006",".","+",".","ID=maker-Group1%2E33-pred_gff_GNOMON-gene-4.137;Name=maker-Group1%252E33-pred_gff_GNOMON-gene-4.137"]).toBeTruthy;
	    });
